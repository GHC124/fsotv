 ...
 *
 */
public class VideoCommentsTabletActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		adapter = new ListCommentAdapter(VideoCommentsTabletActivity.this,
				R.layout.comment_item_tablet, comments);
		// updating listview
